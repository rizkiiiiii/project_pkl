...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('{{ url('assets/img/cars-6.jpg') }}'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Login with Your Account Now!!</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-0 text-center">
                                    ...
                                    <div class="text-lead">
                                        <span class="text-small">Do You not have an account?</span>
                                        <a class="btn btn-link mb-0 ps-0" href="{{ route('register') }}">Register here!</a>
                                    </div>
                                </div>
                            </form>
                        </div>
