...
@section('content')
    ...
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg"
            style="background-image: url('{{ url('assets/img/cars-7.jpg') }}'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Register Your Account Now!!</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
                <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
                    <div class="card mb-5 z-index-0">
                        <div class="card-header text-center pt-4 fs-4 fw-bold">
                            Register
                        </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="text-lead text-center mt-4">
                                    <span class="text-small">Do You already have an account?</span>
                                    <a class="btn btn-link mb-0 ps-0" href="{{ route('login') }}">Login here!</a>
                                </div>
